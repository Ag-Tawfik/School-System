...
class AddParent extends Component
{
    ...
    public function firstStepSubmit()
    {
        $this->validate([
            ...
            'fatherNationalID' => 'required|unique:parents,fatherNationalID',
            'fatherPassportID' => 'required|unique:parents,fatherPassportID',
    ...
    public function secondStepSubmit()
    {
        ...
        $this->validate([
            ...
            'motherNationalID' => 'required|unique:parents,motherNationalID',
            'motherPassportID' => 'required|unique:parents,motherPassportID',
