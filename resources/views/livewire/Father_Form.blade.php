<div class="setup-content" id="step-1" style="{{ $currentStep != 1 ? 'display: none' : '' }}">
<div class="col-xs-12">
    <div class="col-md-12">
        <br>
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <input type="text" wire:model.live="fatherName" class="form-control">
                @error('fatherName')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="col">
                ...
                <input type="text" wire:model.live="fatherName_en" class="form-control">
                @error('fatherName_en')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-row">
            <div class="col-md-3">
                ...
                <input type="text" wire:model.live="fatherJobTitle" class="form-control">
            ...
            <div class="col-md-3">
                ...
                <input type="text" wire:model.live="fatherJobTitle_en" class="form-control">
            ...
            <div class="col">
                ...
                <input type="text" wire:model.live="fatherNationalID" class="form-control">
            ...
            <div class="col">
                ...
                <input type="text" wire:model.live="fatherPassportID" class="form-control">
            ...
            <div class="col">
                ...
                <input type="text" wire:model.live="fatherPhoneNumber" class="form-control">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <select class="custom-select my-1 mr-sm-2" wire:model.live="fatherNationalty_id">
            ...
            <div class="form-group col">
                ...
                <select class="custom-select my-1 mr-sm-2" wire:model.live="fatherBloodType_id">
                    <option selected>{{ trans('Parent_trans.Choose') }}...</option>
            ...
            <div class="form-group col">
                ...
                <select class="custom-select my-1 mr-sm-2" wire:model.live="fatherReligion_id">
                    <option selected>{{ trans('Parent_trans.Choose') }}...</option>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" wire:model.live="fatherAddress" id="exampleFormControlTextarea1" rows="4"></textarea>
            @error('fatherAddress')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
